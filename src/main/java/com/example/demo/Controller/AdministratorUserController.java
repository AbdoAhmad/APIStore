...
public class AdministratorUserController implements UserController<AdministratorUser> {
    ...
    //get administratoruser by email
    @Override
    @GetMapping("getadministratoruser/{email}")
    public ResponseEntity<AdministratorUser> getUserByEmail(@PathVariable(value = "email") String userEmail) throws ResourceNotFoundException {
        ...
        return ResponseEntity.ok().body(administratorUser);
    }
    ...
    //update administratoruser by email
    @Override
    ...
    // delete administratoruser by email
    @Override
    ...
    @Override
    public AdministratorUser signUp(@Valid AdministratorUser user) throws ResourceNotFoundException {
        return null;
    }

    @Override
    @GetMapping("loginasadmin")
    public AdministratorUser logIn(@Valid AdministratorUser user) throws ResourceNotFoundException {
